# -*- coding: utf-8 -*-
"""cs480_char_rnn_classification_tutorial.ipynb
...
class GRU(nn.Module):
    ...
    def forward(self, input, hidden):
        ...
        output=self.softmax(self.out(hidden[0]).view(1,-1))
...
import csv
with open("/content/drive/My Drive/CS680/A5/1a_LSTM.csv", 'w') as csvFile:
