# -*- coding: utf-8 -*-
"""cs480_seq2seq_translation_tutorial.ipynb
...
def train(input_tensor, target_tensor, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=MAX_LENGTH):
    ...
    decoder_hidden = encoder_output #without attention, the inital hidden state is the context vector
...
def trainIters(encoder, decoder, n_iters, print_every=2000, plot_every=1000, learning_rate=0.01):
    ...
    import csv
    with open("/content/drive/My Drive/CS680/A5/1c_noattention_noteacher.csv", 'w') as csvFile:
        writer = csv.writer(csvFile)
        for item in plot_test_losses:
...
trainIters(encoder1, decoder, 75000)
...
output_words, attentions = evaluate(
    encoder1, decoder, "je suis trop froid .")
